...
import { FaUser, FaEnvelope, FaPhone, FaBuilding, FaCalendar, FaClock } from 'react-icons/fa';
        ...
        <Layout>
            <div className="mx-4 mt-10">
                <div className="flex justify-between mb-2">
                    ...
                    <Button size='md' className="" onClick={handleAddStaff}>Add Staff</Button>
                </div>
                    ...
                    {staffMembers.map((staff) => (
                        <div key={staff.id} className="bg-slate-100 p-4 rounded-md shadow-md">
                            ...
                            <div className="flex justify-between mt-4">
                                <Button className="text-blue-500" onClick={() => handleEditStaff()}>Edit</Button>
                                <Button className="!bg-red-400" onClick={() => handleDeleteStaff()}>Delete</Button>
                            </div>
                        </div>
                    ))}
                </div>
